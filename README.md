...
- **Terminal:** every new terminal window opens with the wolf and your system info (`fastfetch`; `wolf fastfetch off` hides it), and an icy [starship](https://starship.rs) prompt (`wolf prompt off` turns it off)
